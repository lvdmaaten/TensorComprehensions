...
isl::UnionSet<Domain> partialTargetTiles(
    isl::UnionSet<Domain> domain,
    isl::MultiUnionPwAff<Domain, Prefix> prefix,
    isl::MultiUnionPwAff<Domain, Pretile> pretile,
    isl::multi_val size) {
  ...
  auto sameTile =
      isl::UnionMap<Pretile, Pretile>(tileMap.apply_range(tileMap.reverse()));
